...
class AssignData {
  ...
  factory AssignData.fromJson(Map<String, dynamic> json) => AssignData(
        ...
        details: List<AssignDetails>.from(
            json["details"].map((x) => AssignDetails.fromJson(x))),
        parent: List<dynamic>.from(json["parent"].map((x) => x)),
        child: List<AssignDetails>.from(
            json["child"].map((x) => AssignDetails.fromJson(x))),
      );
...
class AssignDetails {
  ...
  List<ClassRoomFile>? classroomFiles;
  String? title;
  String? description;
  String? file;
  DateTime? dateAdded;
  ...
  factory AssignDetails.fromJson(Map<String, dynamic> json) => AssignDetails(
        ...
        classroomFiles: json["classroom_files"] != null
            ? List<ClassRoomFile>.from(json["classroom_files"].map((x) => ClassRoomFile.fromJson(x)))
            : [],
        title: json["title"],
