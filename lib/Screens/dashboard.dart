...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  void _handleMessage(RemoteMessage message) {
    switch(message.data['category']) {
      case "CIRCULAR": widget.dashSwitching(1, message.data['_id'] ?? "dd", true);
      break;
      case "ASSIGNMENT": widget.dashSwitching(2, message.data['_id'] ?? "dd", true);
      break;
      case "ATTENDANCE": widget.dashSwitching(3, "dd", true);
      break;
      default: widget.dashSwitching(0, "dd", true);
    }
  }
  ...
  void initState() {
    ...
    _buttonController =
        AnimationController(vsync: this, duration: const Duration(milliseconds: 300));
    _slideTransition =
        _controller!.drive(Tween(begin: const Offset(1.5, 0), end: const Offset(0, 0)));
    _heightanimation = _buttonController!.drive(Tween<Size>(begin: Size(120.w, 50.h), end: Size(60.w, 50.h)));
    _buttonText = _buttonController!.drive(Tween<Size>(begin: Size(50.w, 0), end: const Size(0, 0)));
                ...
                children: [
                  ...
                  RefreshIndicator(
                    onRefresh: () =>
                        _dashBoardFeed(widget.parentId, widget.childId),
                    child: Container(
                      height: 1.sh - 400, // - _heightanimation!.value.height,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      _circFormatter.format(date!.toLocal()),
                      textScaleFactor: 0.9,
                      style: dateTextStyle,
                    )
                  ],
  ...
  Widget report(
      ...
      InkWell(
        onTap: () {
          widget.dashSwitching(5, 'Report', true);
          // print('report');
        },
        child: SlideTransition(
          position: _slideTransition!,
  ...
  Widget exam(
      ...
      InkWell(
        onTap: () {
          widget.dashSwitching(5, 'Exam', true);
          //print('exam');
        },
        child: SlideTransition(
          position: _slideTransition!,
