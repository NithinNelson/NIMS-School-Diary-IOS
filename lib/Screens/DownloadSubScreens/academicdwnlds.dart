...
class AcademicDownloads extends StatefulWidget {
  ...
  const AcademicDownloads({Key? key, this.studId, required this.loader}) : super(key: key);
...
class _AcademicDownloadsState extends State<AcademicDownloads> {
  ...
  getAssignments() async {
    ...
    assignments.clear();
    assignments = await getFiles('Assignment', widget.studId);
  ...
  @override
  void didUpdateWidget(covariant AcademicDownloads oldWidget) {
    getAssignments();
