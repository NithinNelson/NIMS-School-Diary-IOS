...
import 'package:educare_dubai_v2/Models/message_unread_count.dart';
import 'package:educare_dubai_v2/Screens/timetable_screen.dart';
...
import 'allLeave.dart';
import 'assignment_screen.dart';
import 'calendar_screen.dart';
import 'chattingScreen/chat_rooms.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  var _userdata = Users();
  MessageCount _messageCount = MessageCount();
  ...
  setupNotification(String email) async {
    print('user email id---->$email');
    var token = await fbToken();
    // FirebaseMessaging.instance.onTokenRefresh.listen((fcmToken) async {
    print('fcm response-----------$token');
    var resp = await Provider.of<UserProvider>(context, listen: false)
        .tokenUpdate(email, token);
  ...
  Future<dynamic> _initialize() async {
    ...
    if (!keyboardEnabled) {
      ...
      _pages = [
        ...
        {
          'page': LeaveRequest(
            imageUrl: _userdata.data!.data![0].studentDetails!.first.photo,
            stdName: _userdata.data!.data![0].studentDetails!.first.name,
            academicYear: _userdata.data!.data![0].studentDetails!.first.academicYear,
            batchId: _userdata.data!.data![0].studentDetails!.first.batchId,
            batchName: _userdata.data!.data![0].studentDetails!.first.batch,
            classId: _userdata.data!.data![0].studentDetails!.first.classId,
            className: _userdata.data!.data![0].studentDetails!.first.studentDetailClass,
            curriculumId: _userdata.data!.data![0].studentDetails!.first.curriculumId,
            curriculumName: _userdata.data!.data![0].studentDetails!.first.curriculum,
            schoolId: _userdata.data!.data![0].studentDetails!.first.schoolId,
            sessionId: _userdata.data!.data![0].studentDetails!.first.sessionId,
            sessionName: _userdata.data!.data![0].studentDetails!.first.session,
            studentId: _userdata.data!.data![0].studentDetails!.first.userId,
            studentName: _userdata.data!.data![0].studentDetails!.first.name,
            userId: _userdata.data!.data![0].id,
            pageUpdate: updatePage,
          ),
          'title': 'Leave Request',
          'centre': true,
        ...
        },
        {
          'page': ChatRooms(
            studId: _userdata.data!.data![0].studentDetails!.first.userId,
            studentName: _userdata.data!.data![0].studentDetails!.first.name,
            parentId: _userdata.data!.data![0].id,
          ),
        ...
        },
        {
          'page': AllLeave(
            studentId: _userdata.data!.data![0].studentDetails!.first.userId,
            schoolId: _userdata.data!.data![0].studentDetails!.first.schoolId,
            academicYr: _userdata.data!.data![0].studentDetails!.first.academicYear,
            pageUpdate: updatePage,
          ),
          'title': 'All Leaves',
          'centre': true,
      ...
      timer = Timer.periodic(const Duration(seconds: 3), (timer) async => await _messageCountGet());
    } else {}
  }

  Future<dynamic> _messageCountGet() async {
    List<Map> students = [];
    for (var student in _userdata.data!.data![0].studentDetails!) {
      students.add({
        "student_id": student.userId,
        "class": student.studentDetailClass,
        "batch": student.batch
      });
    }
    try {
      var resp = await Provider.of<UserProvider>(context, listen: false)
          .getMessageCount(parentId: _userdata.data!.data![0].id.toString(), student: students);

    setState(() => _messageCount = MessageCount.fromJson(resp));
    ...
    setState(() {
      ...
      _pages = [
        ...
        },
        {
          'page': TimeTable(
            schoolId: _userdata.data!.data![0].schoolId,
            userId: _students[pageIndex].userId,
            sessionId: _students[pageIndex].sessionId,
            curriculumId: _students[pageIndex].curriculumId,
            classId: _students[pageIndex].classId,
            batchId: _students[pageIndex].batchId,
            academicYear: _students[pageIndex].academicYear,
          ),
          'title': 'Timetable',
          'centre': true,
          'isPopup': true
        ...
        {
          'page': LeaveRequest(
            imageUrl: _students[pageIndex].photo,
            stdName: _students[pageIndex].name,
            academicYear: _students[pageIndex].academicYear,
            batchId: _students[pageIndex].batchId,
            batchName: _students[pageIndex].batch,
            classId: _students[pageIndex].classId,
            className: _students[pageIndex].studentDetailClass,
            curriculumId: _students[pageIndex].curriculumId,
            curriculumName: _students[pageIndex].curriculum,
            schoolId: _students[pageIndex].schoolId,
            sessionId: _students[pageIndex].sessionId,
            sessionName: _students[pageIndex].session,
            studentId: _students[pageIndex].userId,
            studentName: _students[pageIndex].name,
            userId: _userdata.data!.data![0].id,
            pageUpdate: updatePage,
          ),
          'title': 'Leave Request',
        ...
        },
        {
          'page': AllLeave(
            studentId: _students[pageIndex].userId,
            schoolId: _students[pageIndex].schoolId,
            academicYr: _students[pageIndex].academicYear,
            pageUpdate: updatePage,
          ),
          'title': 'All Leaves',
          'centre': true,
  ...
  void updateValue(bool newValue) {
    setState(() {
      _floatExpand = newValue;
    });
  }
  void updatePage(int newValue) {
    setState(() {
      _seletedPageIndex = newValue;
    });
  }
  ...
  Widget build(BuildContext context) {
    // String title = _pages[_seletedPageIndex]['title'].toString();
    // bool isCentre = _pages[_seletedPageIndex]['centre'] as bool;
    // bool isPop = _pages[_seletedPageIndex]['isPopup'] as bool;
    // Widget widget = _pages[_seletedPageIndex]['page'] as Widget;
    return WillPopScope(
      onWillPop: () async {
        ...
        showGeneralDialog(
          ...
          transitionBuilder: (ctx, a1, a2, child) {
            ...
            return Transform.scale(
              scale: curve,
              child: AlertDialog(
                title: const Text('Exit from School Diary ?'),
                actions: [
                  ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        elevation: 0, backgroundColor: Color(0xff8e2de2),
      ...
      child: SafeArea(
        child: Scaffold(
          key: _key,
          backgroundColor: _bagColor(_pages[_seletedPageIndex]['title'].toString()),
          //endDrawer: NotifWidget(parentId: _userdata.data!.data![0].id),
          appBar: _pages[_seletedPageIndex]['centre'] as bool
              ? AppBar(
            title: Text(
            ...
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.only(
                    bottomRight: Radius.circular(_pages[_seletedPageIndex]['title'].toString() == "About" ? 0 : 20),
                    bottomLeft: Radius.circular(_pages[_seletedPageIndex]['title'].toString() == "About" ? 0 : 20))),
                                                ...
                                                children: [
                                                  ElevatedButton(
                                                    onPressed: () async {
                                                      ...
                                                      var dir = Directory('$path/SchoolDiary');
                                                      if (await dir.exists()) {
          ...
          floatingActionButton: CustomFloatingActionButton(
            seletedPageIndex: _seletedPageIndex,
            studentList: _userdata.data!.data![0].studentDetails,
            unreadMsg: _messageCount,
            dashChildId: _selectedChild,
            callback: updateValue,
            pageUpdate: updatePage, pageSwitch: (int index) {
            setState(() {
              _activeindex = index;
              _pageSwitching(_activeindex);
            });
              ...
              Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    right: 0,
                    left: 0,
                    child: _pages[_seletedPageIndex]['centre'] as bool
                        ? Container(
                      // child: customAppBar(
                      //     isPop: isPop,
                  ...
                  _pages[_seletedPageIndex]['title'].toString() == "My Profile"
                      ? _pages[_seletedPageIndex]['page'] as Widget
                      : Positioned(
                    bottom: 120,
                    left: 0,
                    right: 0,
                    child: _pages[_seletedPageIndex]['page'] as Widget,
                  ),
                  if (_floatExpand)
                    Container(
                      width: MediaQuery.of(context).size.width,
                      height: MediaQuery.of(context).size.height,
                      color: ColorUtil.white.withOpacity(0.5),
                    ),
                ],
              ),
            ],
  ...
  Widget _customBottomNavBar() => Stack(
    children: [
      Container(
        width: double.infinity,
        height: 90,
  ...
  Color _bagColor(String screen) {
    switch(screen) {
      case "Circulars": return ColorUtil.mainBg;
      case "Assignments": return ColorUtil.mainBg;
      case "Downloads": return ColorUtil.mainBg;
      case "My Profile": return ColorUtil.mainBg;
      case "Timetable": return ColorUtil.mainBg;
      case "Calendar": return ColorUtil.white;
      case "Chat With Teacher": return ColorUtil.white;
      case "Fees": return ColorUtil.white;
      case "Assessments": return ColorUtil.white;
      case "About": return ColorUtil.mainBg;
      case "Leave Request": return ColorUtil.white;
      default: return ColorUtil.mainBg;
    }
  }
