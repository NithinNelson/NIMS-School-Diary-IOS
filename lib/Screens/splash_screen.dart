...
class _SplashScreenState extends State<SplashScreen> {
  ...
  navigation(bool time) async {
    ...
    if(prefs.getBool('loginOrNot') == true){
      _user = Users.fromJson(json.decode(prefs.getString('loginResponse')!));
  ...
  Future<void> _cacheClear() async => await APICacheManager().emptyCache();
