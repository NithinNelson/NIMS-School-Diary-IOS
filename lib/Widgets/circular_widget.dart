...
import 'package:educare_dubai_v2/Models/assignment_model.dart';
...
import 'attachedUrl_widget.dart';
...
// final bool isOpen;
  ...
  final List<ClassRoomFile>? classroomFiles;
...
class _CircularWidgetState extends State<CircularWidget> {
  ...
  Future<void> _launchUrl(String url) async {
    ...
    try {
      if (!await launchUrl(Uri.parse(webLink), mode: LaunchMode.externalApplication)) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  (widget.webLink != null && widget.webLink != "")? InkWell(
                    onTap: (){
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text('Open Weblink',textScaleFactor:1,style: TextStyle(
                  ...
                  Container(
                    height: double.parse("${widget.attachment!.length}") * 40,
                    child: ListView.builder(
                        ...
                        AttachmentWidget(
                          ...
                          circularDesc: widget.circularDesc!,
                          totalAtt: i,
                          issuedBy: widget.senderName!,
                        )),
                  ),
                  Container(
                    height: _attachHeight(widget.classroomFiles!.length), // Calculate the height based on the number of items and grid layout
                    child: GridView.builder(
                      ...
                      itemCount: widget.classroomFiles!.isEmpty ? 0 : widget.classroomFiles!.length,
                      itemBuilder: (ctx, i) => AttachUrlWidget(file: widget.classroomFiles![i]),
                    ),
                  ),
                  Text(
                    'Issued by ${widget.senderName!}',
                    textScaleFactor:1.0,
          ...
          //           crossAxisAlignment: CrossAxisAlignment.start,
          //           children: [
          //             Text(widget.circularDesc!,textScaleFactor:1.0,style: TextStyle(
          //               fontSize: 14
          //             ),),
          //             SizedBox(
          //               height: 6,
          ...
          //                         circularDesc: widget.circularDesc!,
          //                         totalAtt: i,
          //                         issuedBy: 'Issued by ${widget.senderName!}',
          //                       )),
          //             ),
          //             Text('Issued by ${widget.senderName!}',textScaleFactor:1.0,style: TextStyle(fontSize: 14),)
          //           ],
          //         ),
          //       ),
          //     ],
