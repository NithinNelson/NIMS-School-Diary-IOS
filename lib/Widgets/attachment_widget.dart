...
class _AttachmentWidgetState extends State<AttachmentWidget> {
  ...
  Future checkExist() async {
    ...
    // if (checkPermission == true) {
      ...
      print('path-------->$path');
      var dir = await Directory('$path/SchoolDiary/${widget.childId}/${widget.type}');
      try {
  ...
  Future<File?> downloadFile(String url, String filename) async {
    ...
    // if (await Permission.storage.request().isGranted) {
      ...
      //final path = await ExternalPath.getExternalStoragePublicDirectory(ExternalPath.DIRECTORY_DOWNLOADS);
      final path = (await getApplicationDocumentsDirectory()).path;
      var dir = Directory('$path/SchoolDiary/${widget.childId}/${widget.type}');
  ...
  Future _fetchSchoolName() async {
    ...
    String? output = prefs.getString('loginResponse');
    if (output != null) {
